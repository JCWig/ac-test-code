 ...
 * or can be a translation key {string|TranslateKey}. In addition, If translation keys are provided, we have provided
 * "*Values" properties to for each of above properties in case variable replacement needed.
 *
