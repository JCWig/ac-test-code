 ...
 * or can be a translation key. In addition to that, we have provided values property to
 * those properties that requires translation if variable replacement needed.
 * For example: options.title = "someKey" (value has embeded variable replacement:
 * {{first}} {{last}}), options.titleValues = {'first': 'sean', 'last': 'wang'},
 * it will render: sean wang.  Same logic applies for cancelLabel and submitLabel properties
 *
 */
